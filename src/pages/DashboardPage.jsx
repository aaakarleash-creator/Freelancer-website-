...
import { mockLeads, mockLeaderboard } from '../data/mockData';
...
export default function DashboardPage({ onNavigate }) {
  ...
  const totalEarnings = 72000; // Mock
        ...
        <div className="bg-dark-700 border border-dark-400 rounded-2xl">
          ...
          <div className="p-4 space-y-2">
            {mockLeaderboard.slice(0, 5).map((user, i) => (
              ...
              `}>
                <span className="text-lg w-6 text-center leading-none">{user.badge || `${i+1}`}</span>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">{user.convertedClients} converts</p>
                </div>
