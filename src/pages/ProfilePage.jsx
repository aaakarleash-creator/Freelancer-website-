...
export default function ProfilePage() {
  ...
  const saveProfile = () => {
    // TODO: call supabase.from('profiles').update(form).eq('id', currentUser.id)
    setEditing(false);
  };
      ...
      <div className="bg-dark-700 border border-dark-400 rounded-2xl overflow-hidden">
        ...
        <div className="px-6 pb-6">
          <div className="-mt-8 flex items-end justify-between">
            <Avatar initials={currentUser?.avatar} size="xl" className="ring-4 ring-dark-700" />
            <div className="mb-1">
              {!editing ? (
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" icon={Save} onClick={saveProfile}>Save</Button>
                </div>
              )}
            </div>
          </div>
